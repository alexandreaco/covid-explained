  ...
  <div class="home">
    ...
    <div class="preamble">
      <p class="text-2xl md:text-3xl">
        <strong>COVID-19 is confusing.</strong> There's a lot of conflicting information out there—<a href="/post/zRkgD1uKDkQrLT4PmVmK"
    ...
    <div class="block">
      <h2 class="text-2xl mt-24 mb-8 font-bold">We hear a lot of the same questions, we're here with answers.</h2>

    ...
    <form class="card-panel" @submit.prevent>
      ...
      <div class="field">
        ...
        <div class="image-instructions">
          ...
          <br />
          <p>
            Images can be used by clicking the image icon in the text editor and then entering the image url. If you'd like to upload
            an image from your computer and it does not have a url, follow these steps to generate a url:
          </p>
          <ol>
            <li>Click the 'Choose File' button.</li>
            <li>Select your file.</li>
            <li>
              Click 'Get Image Url' button. A url and an image preview should pop up.
            </li>
            <li>Copy the url</li>
